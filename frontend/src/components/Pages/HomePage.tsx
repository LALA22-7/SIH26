  ...
  return (
    <div className="w-full h-full overflow-y-auto custom-scrollbar">
      <div className="max-w-5xl mx-auto px-6 py-10 flex flex-col gap-16">
        ...
        {/* Hero */}
        <section className="text-center flex flex-col items-center gap-6" aria-labelledby="hero-title">
          <div className="flex items-center gap-3 mb-2">
            <img src="/logo.png" alt="" className="w-14 h-14 rounded-2xl shadow-[0_0_30px_rgba(79,195,224,0.4)]" />
          </div>
          <h1 id="hero-title" className="text-4xl md:text-5xl font-bold tracking-tight text-white leading-tight">
            CycloneWatch
          </h1>
        ...
        {/* The Problem */}
        <section className="glass-card rounded-2xl p-8 border border-alert/20 bg-alert/5" aria-labelledby="problem-title">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-alert/20 flex items-center justify-center" aria-hidden="true">
              <Shield size={20} className="text-alert" />
            </div>
            <h2 id="problem-title" className="text-2xl font-bold text-white">The Problem</h2>
          </div>
        ...
        {/* Our Solution */}
        <section className="glass-card rounded-2xl p-8" aria-labelledby="solution-title">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-cyan-500/20 flex items-center justify-center" aria-hidden="true">
              <Zap size={20} className="text-cyan-400" />
            </div>
            <h2 id="solution-title" className="text-2xl font-bold text-white">Our Solution</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="flex flex-col gap-2 p-4 rounded-xl bg-ocean-900/50 border border-ocean-800">
                <item.icon size={20} className="text-cyan-400" aria-hidden="true" />
        ...
        <section className="glass-card rounded-2xl p-8" aria-labelledby="comparison-title">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-confidence/20 flex items-center justify-center" aria-hidden="true">
              <BarChart3 size={20} className="text-confidence" />
            </div>
            <h2 id="comparison-title" className="text-2xl font-bold text-white">Traditional NWP vs CycloneWatch</h2>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <caption className="sr-only">Comparison of traditional NWP methods versus CycloneWatch AI capabilities</caption>
              <thead>
                <tr className="border-b border-ocean-800">
                  <th scope="col" className="text-left py-3 px-4 text-text-muted font-medium tracking-widest uppercase text-xs">Aspect</th>
                  <th scope="col" className="text-left py-3 px-4 text-text-muted font-medium tracking-widest uppercase text-xs">Traditional (NWP/Dvorak)</th>
                  <th scope="col" className="text-left py-3 px-4 text-cyan-400 font-medium tracking-widest uppercase text-xs">CycloneWatch AI</th>
                </tr>
              </thead>
